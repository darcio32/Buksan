...
function HeaderBeam(pn_is_sub){
  ...
  document.write(
     "<A HREF=\'"+getpath(pn_is_sub)+"pages/offer.html'>"+
	   	"<IMG SRC=\'"+getpath(pn_is_sub)+"pictures/menu_offer.gif' WIDTH=\'97' HEIGHT=\'18' BORDER=\'0' ALT=\'Zapoznaj się z naszą ofertą'"+
  ...
  document.write(
		"<A HREF=\'"+getpath(pn_is_sub)+"pages/about.html'>"+
		   "<IMG SRC=\'"+getpath(pn_is_sub)+"pictures/menu_about.gif' WIDTH='97' HEIGHT='18' BORDER='0' ALT='O nas - Wczoraj, dziś, jutro...' "+
